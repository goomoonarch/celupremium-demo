    ...
    <div className="relative mb-0">
      ...
      >
        ...
        <li
          ...
          style={{ opacity: 0, transform: "translateY(50px)" }}
        >
          <div className="slide-center-card shrink-0">
            <div className="bg-[#F5F5F7] w-[312px] h-[540px] rounded-[20px] p-[36px] cursor-default overflow-hidden hover:translate-y-[-20px] transition-all ease-out duration-150">
              <img
                src={cinematicMode}
        ...
        <li
          ...
          style={{ opacity: 0, transform: "translateY(50px)" }}
        >
          <div className="slide-center-card absolute shrink-0">
            <div
              className="w-[312px] h-[540px] rounded-[20px] p-[36px] cursor-default overflow-hidden hover:translate-y-[-20px] transition-all ease-out duration-150"
              style={{
            ...
            >
              ...
              <p className="text-white leading-6 mb-10">
                Captura fotos más claras, más nítidas e impresionantes con el
                modo Noche en todas tus cámaras.
              </p>
            </div>
          </div>
        </li>
